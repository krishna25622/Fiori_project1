		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#saptrainingcomproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingcomproject1-display": {
								"semanticObject": "saptrainingcomproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.com.project1",
									"url": sap.ui.require.toUrl("sap/training/com/project1")
								}
							}
						}
					}
